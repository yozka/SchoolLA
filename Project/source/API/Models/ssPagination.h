...
namespace API
{
	///----------------------------------------------------------------------------
	 ...
	 ///---------------------------------------------------------------------------
	///
	/// Система пагинации для данных
	/// 
	///
	///----------------------------------------------------------------------------
	class APagination : public QObject
	{
		Q_OBJECT

	public:
		Q_INVOKABLE explicit APagination(QObject *parent = 0);
	...
	private:
		int					mPerPage;
		int					mCurrentPage;
		QString				mCurrentPageHeader;
		int					mTotalCount;
		QString				mTotalCountHeader;
		int					mPageCount;
		QString				mPageCountHeader;
		PaginationPolicy	mPolicy;
		int					mLimit;
		int					mOffset;
		QString				mCursorQueryParam;
		QString				mCursorValue;
	};
